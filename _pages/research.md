...
Before working as a research associate at RareCyte, Inc., I performed molecular characterization of cancer subtypes for diagnosis, prognosis, and treatment compatibility using next-generation sequencing, polymerase chain reaction, fluorescence in-situ hybridization, and flow cytometry, alongside other methods, in the molecular oncology department at CellNetix Pathology and Laboratories, LLC. In addition to working at the bench, I coordinated with pathologists, surgeons, and other physicians to facilitate access to effective treatment options for patients.
