...
<div style="margin-top: 30px; display: flex; align-items: center; margin-bottom: 24px;">
  <img src="{{ site.baseurl }}/images/orionFigure1.png" alt="Research Image" style="width: 50%; height: auto; margin-right: 30px;">
  <p style="font-size: 0.85em; font-style: italic;">Highly multiplexed immunofluorescence staining and imaging method, from Sorger et al., 2023. a, 16- to 20-channel multiplexed immunofluorescence (IF) staining and imaging workflow. b, CD31, α-SMA, Hoechst (DNA) IF and hematoxylin and eosin (H&E) staining from a single colorectal cancer tissue section. c, Whole-tissue formalin-fixed paraffin-embedded section with IF staining of CD45, pan-cytokeratin, CD31, and α-SMA and matched H&E with tissue "cores" removed to construct tissue microarrays. d, Zoom-in views of arrowheads in c with 16-channel IF staining. e, Intensities of fluorochromes in each imaging channel. </p>
<div style="clear: both;"></div>
</div>

Before transitioning into geoscience, I worked in biomedicine. At RareCyte, Inc., I designed and optimized highly multiplexed immunofluorescence staining and imaging methods and developed and validated clinical circulating tumor and rare cell biomarker assays. My goal was to create novel methods for visualizing and quantifying protein expression in tissue microenvironments and rare circulating cells. In this work, I used highly-multiplexed immunofluorescence staining, flow cytometry, antibody-fluorophore conjugation, immunohistochemistry, and spectrophotometry, amongst other techniques. The methods I developed in this role have been used by physicians to track disease progression, differentiate disease phenotypes, and guide treatment decisions for patients in the clinic. My work as a research associate also enabled collaborators to advance drug development for a range of diseases, including various cancers and autoimmune diseases, such as rheumatoid arthritis. Before working as a research associate at RareCyte, Inc., I performed molecular characterization of cancer subtypes for diagnosis, prognosis, and treatment compatibility using next-generation sequencing, polymerase chain reaction, fluorescence in-situ hybridization, and flow cytometry, alongside other methods, in the molecular oncology department at CellNetix Pathology and Laboratories, LLC. In addition to working at the bench, I coordinated with pathologists, surgeons, and other physicians to facilitate access to effective treatment options for patients.
