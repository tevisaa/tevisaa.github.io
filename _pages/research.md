...
Previously, in the Winkler Lab, I studied how methanogenic microbial communities respond to temperature and hydrologic perturbations to predict wetland climate feedbacks. Using batch bottles and continuous-feed bioreactors with hydrogel-embedded environmental samples, I quantified biogeochemical responses and greenhouse gas fluxes with gas chromatography, high-performance liquid chromatography, and spectrophotometry. I also constrained microbial community composition and spatial organization using 16S rRNA gene sequencing, cryosectioning, and fluorescence in situ hybridization. In this project, I learned to design experiments around difficult-to-observe processes, link microbial activity to ecosystem-scale outcomes, and interpret complex, noisy data—building intuition for systems with many interacting components and feedbacks that complicate simple explanations.